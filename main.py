...
def attack(char_name: str, char_class: str) -> str:
    """Возвращвет нанесённый урон в зависимости от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокированный урон в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает специальное умение в зависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Печатает информацию о выбранном персонаже и предлагает тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает выбрать персонажа и выводит его описание."""
    approve_choice: str = ''
    char_class: str = ''
